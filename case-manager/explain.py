...
_PHRASES = {
    ...
    "payee_payers_96h":       ("distinct people paying this payee in four days", lambda v: f"{int(v)}"),
    "sender_payers_96h":      ("distinct people who paid the sender in four days", lambda v: f"{int(v)}"),
    "sender_payees_96h":      ("distinct payees of the sender in four days", lambda v: f"{int(v)}"),
    "payee_payees_96h":       ("distinct payees of this payee in four days", lambda v: f"{int(v)}"),
    "money_back_96h":         ("transfers from this payee back to the sender in four days", lambda v: f"{int(v)}"),
