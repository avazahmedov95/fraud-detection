...
_PHRASES = {
    ...
    "rcv_distinct_senders_24h": ("distinct senders paying this payee in a day", lambda v: f"{int(v)}"),
    "sender_inflow_24h":      ("money the sender itself received in a day", lambda v: _uzs(pow(2.718281828, v) - 1) + " UZS"),
    "sender_distinct_payers_24h": ("people who paid the sender in a day", lambda v: f"{int(v)}"),
